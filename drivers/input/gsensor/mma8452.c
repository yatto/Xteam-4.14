...
// Queste righe Vanno bene per JB 4.1.1 e 4.2.2	
	x = mma8452_convert_to_int(buffer[1]);  //Portrait
	y = -mma8452_convert_to_int(buffer[0]); //Landscape 
	z = mma8452_convert_to_int(buffer[2]);  //Tab Sul Piano
//
/* Queste righe Vanno bene per CM10.1 by OMA	
	x = -mma8452_convert_to_int(buffer[0]);  //Landscape
	y = -mma8452_convert_to_int(buffer[1]);  //Portrait
	z = mma8452_convert_to_int(buffer[2]);  //Tab Sul Piano
*/
