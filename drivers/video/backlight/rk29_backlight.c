...
#ifndef MIN_BACKLIGHT_SCALE
#define MIN_BACKLIGHT_SCALE 12
#endif

#ifndef BACKLIGHT_REDUCE_VALUE
#define BACKLIGHT_REDUCE_VALUE 0
#endif
...
static int rk29_bl_update_status(struct backlight_device *bl)
{
	...
	if (ref) {
		...
		divh = divh*MIN_BACKLIGHT_SCALE/20 + BACKLIGHT_REDUCE_VALUE; 
	}
...
static void rk29_bl_suspend(struct early_suspend *h)
{
	...
	gpio_set_value(BACKLIGHT_CONTROL_PIN, !BACKLIGHT_CONTROL_VALUE);
	msleep(100);
#endif
